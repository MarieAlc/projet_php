...
class ControllerGestionUtilisateur extends Controller {
    ...
    public function modifierRendezVousUtilisateur(){
       ...
       if(isset($_GET['id'])){
            ...
            if ($_SERVER['REQUEST_METHOD'] === 'POST') {
                ...
                header('Location: /test/projet_php/index.php?action=listerendezvousutilisateur');
                exit;
            }
            $views = new Views();
    ...
    public function modifierProfilUtilisateur() {
        ...
        if($_SERVER['REQUEST_METHOD'] === 'POST') {
            ...
            try {
                $utilisateurManager->modifierUtilisateur($userId, $nom, $prenom, $mail,$telehpone, $motDePasse);
